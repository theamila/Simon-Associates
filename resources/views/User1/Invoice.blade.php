...
<div class="row d-flex justify-content-between text-dark fw-bold" style="font-size: 10pt;">
  ...
  @endphp
    ...
    <div class="row mb-3 mt-3 d-flex justify-content-end">
      ...
      <div class="col">
        <input type="number" id="dollarRate" name="dollarRate" class="form-control" step="0.01" placeholder="Enter dollar rate" value="1.0" title="Doller Rate">
      </div>
      <div class="col">
        <input type="date" id="date" name="date" class="form-control" value="{{ date('Y-m-d') }}" title="Date">
      </div>
...
@if ($invoice_data->count() > 0)
        ...
        <tr class="fw-bold">
          ...
          <td class="fw-bold text-center fs-3 text-dark" style="width: 80px;"><i class="{{ $get->Reimbursables == 1 ? 'fas fa-registered' : '' }}"></i>
          </td>
