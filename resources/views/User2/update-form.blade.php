...
<tr>
    ...
    <td class="text-center">
        <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#updateModal{{ $get->id }}"><i class="material-symbols-outlined">edit_square</i></a>

        <a href="{{ Route('pin', $get->id) }}" class="btn btn-sm {{ $get->default == 0 ? 'btn-success' : 'btn-danger disabled' }}" title="Set To Default">
...
<!-- Modal -->
<div class="modal fade" id="updateModal{{ $get->id }}" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form action="{{ Route('updatedata') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control border" id="acName" name="acName" value="{{ $get->acName }}">
                    </div>
                    <div class="mb-3">
                        <label for="accountNo" class="form-label">Account No</label>
                        <input type="text" class="form-control border" id="accountNo" name="accountNo" value="{{ $get->accountNo }}">
                    </div>
                    <div class="mb-3">
                        <label for="bankName" class="form-label">Bank Name</label>
                        <input type="text" class="form-control border" id="bankName" name="bankName" value="{{ $get->bankName }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control border" id="swiftCode" name="swiftCode" value="{{ $get->swiftCode }}">
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('add.bank') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="acName" class="form-label">A/C Name</label>
                        <input type="text" class="form-control border" id="acName" name="acName" value="">
                    </div>
                    <div class="mb-3">
                        <label for="accountNo" class="form-label">Account No</label>
                        <input type="text" class="form-control border" id="accountNo" name="accountNo" value="">
                    </div>
                    <div class="mb-3">
                        <label for="bankName" class="form-label">Bank Name</label>
                        <input type="text" class="form-control border" id="bankName" name="bankName" value="">
                    </div>
                    <div class="mb-3">
                        <label for="bankAddress" class="form-label">Bank Address</label>
                    ...
                    <div class="mb-3">
                        <label for="swiftCode" class="form-label">Swift Code</label>
                        <input type="text" class="form-control border" id="swiftCode" name="swiftCode" value="">
                    </div>
 ...
 <div class="row">
            <div class="col-12 grid-margin">
              <div class="card shadow" style="border-radius: 15px">
                <div class="card-body">
                  <h4 class="card-title">
                  <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#addUserModal"><i class="material-symbols-outlined btn-icon-prepend">person_add</i> Add a User</button>
                  </h4>
      ...
      <div class="modal-body">
        <form id="registerForm" method="POST" action="{{ route('register') }}">
          ...
          <div class="mb-3">
            ...
            <input type="password" class="form-control" id="passwordConfirmationModal" name="password_confirmation" required>
          </div>
...
<div class="row">
            <div class="col-12 grid-margin">
              <div class="card shadow" style="border-radius: 15px">
                <div class="card-body">
                  <h4 class="card-title">
                  <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#HandlerModal"><i class="material-symbols-outlined btn-icon-prepend">person_add</i> Add a Handler</button>
                  </h4>
                  <div class="table-responsive">
                    <table class="table">
                      <thead>
