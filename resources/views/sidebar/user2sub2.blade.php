        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas shadow" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ Route('user2') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('new-invoice-user') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('two-Outstanding-view') }}">
                            <span class="menu-title">Outstanding</span>
                            <i class="material-symbols-outlined menu-icon">schedule</i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('two-Outstanding-invoice') }}">
