  ...
  <body>
        ...
        <div class="">
	        ...
	        <ul class="list-unstyled components mb-5">
	          <li class="active">
	            <a href="{{ Route('user2') }}"><span class="fa fa-home mr-3"></span> Home</a>
	          </li>
	          <li>
			  ...
			  <li>
	              <a href="{{ route('new-invoice-user') }}"><span class="fa-solid fa-bullhorn mr-3"></span>Invoice Requests</a>
	          </li>
			  ...
			  <li>
              <a href="{{ route('update') }}"><span class="fa-solid fa-gear mr-3"></span> Settings</a>
	          </li>
			  <li>
