        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas shadow" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('new-invoice-user-tree') }}">
                            <span class="menu-title">Invoice Requests</span>
                            <i class="material-symbols-outlined menu-icon">checklist</i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('tree-Outstanding-view') }}">
                            <span class="menu-title">Outstanding</span>
                            <i class="material-symbols-outlined menu-icon">schedule</i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('tree-Outstanding-invoice') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/aging/report/user3">
